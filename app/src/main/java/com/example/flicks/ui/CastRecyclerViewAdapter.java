...
public class CastRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     * Constructor
     */
    public CastRecyclerViewAdapter() {
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = inflater.inflate(R.layout.cast_rv_items, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        Cast cast = mItems.get(position);

        ImageView photoView = ((ViewHolderItem) holder).ivPhoto;
        TextView nameView = ((ViewHolderItem) holder).tvName;
        TextView charcterView = ((ViewHolderItem) holder).tvCharacter;

        nameView.setText(cast.getName());
        charcterView.setText(cast.getCharacter());

        String Url = IMAGE_URL + cast.getProfilePath();
     ...
     */
    public void updateAdapter(List<Cast> tasks) {
        mItems = null;
        mItems = tasks;
